...
public:
    ...
    void setupUi(QMainWindow *QtfirstClass)
    {
        ...
        secondprice->setEnabled(false);
        secondprice->setGeometry(QRect(480, 300, 51, 20));
        secondprice->setFont(font);
